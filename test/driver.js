...
describe('Driver', () => {
  ...
  it(
    'should register a new user, which has a driver with a default location', (
      done) => {
  ...
  it('should log in a new user', (done) => {
    request(app)
      ...
      .send('email=' + util.users.driverUser.email + '&password=' +
        util.users.driverUser.password)
      .end((err, res) => {
  ...
  it('should display the default location on the game page for a new user', (
    done) => {

exports.seed = function(knex, Promise) {
  return knex('cities').del()
    .then(function () {
      return Promise.all([
        /* insert cities */
        knex('cities').insert({name: 'Abeline', latitude: '32.4487364', longitude: '-99.7331439'}),
        knex('cities').insert({name: 'Ackerly', latitude: '32.5264993', longitude: '-101.71597'}),
        knex('cities').insert({name: 'Alice', latitude: '27.7522487', longitude: '-98.0697249'}),
        knex('cities').insert({name: 'Allamoore', latitude: '31.078056', longitude: '-105.003056'}),
        knex('cities').insert({name: 'Alpine', latitude: '30.3584919', longitude: '-103.6610115'}),
        knex('cities').insert({name: 'Altuda', latitude: '30.301944', longitude: '-103.4575'}),
        knex('cities').insert({name: 'Amarillo', latitude: '35.2219971', longitude: '-101.8312969'}),
        knex('cities').insert({name: 'Andrews', latitude: '32.3187158', longitude: '-102.5457155'}),
        knex('cities').insert({name: 'Angeles', latitude: '31.9015146', longitude: '-103.9624216'}),
        knex('cities').insert({name: 'Aransas Pass', latitude: '27.9094677', longitude: '-97.1499898'}),
        knex('cities').insert({name: 'Arlington', latitude: '32.735687', longitude: '-97.1080656'}),
        knex('cities').insert({name: 'Asherton', latitude: '28.4435988', longitude: '-99.7589404'}),
        knex('cities').insert({name: 'Aspermont', latitude: '33.1334307', longitude: '-100.2273276'}),
        knex('cities').insert({name: 'Athens', latitude: '32.2048735', longitude: '-95.8555207'}),
        knex('cities').insert({name: 'Atlanta', latitude: '33.1137419', longitude: '-94.1643537'}),
        knex('cities').insert({name: 'Austin', latitude: '30.267153', longitude: '-97.7430608'}),
        knex('cities').insert({name: 'Ballinger', latitude: '31.7382062', longitude: '-99.9473077'}),
        knex('cities').insert({name: 'Balmorhea', latitude: '30.9843123', longitude: '-103.7446257'}),
        knex('cities').insert({name: 'Bamhart', latitude: '31.1279389', longitude: '-101.170668'}),
        knex('cities').insert({name: 'Bastrop', latitude: '30.1104947', longitude: '-97.3152701'}),
        knex('cities').insert({name: 'Bay City', latitude: '28.9827565', longitude: '-95.969402'}),
        knex('cities').insert({name: 'Baytown', latitude: '29.7355047', longitude: '-94.9774274'}),
        knex('cities').insert({name: 'Beaumont', latitude: '30.080174', longitude: '-94.1265562'}),
        knex('cities').insert({name: 'Beeville', latitude: '28.4008319', longitude: '-97.7483312'}),
        knex('cities').insert({name: 'Belton', latitude: '31.0560132', longitude: '-97.464453'}),
        knex('cities').insert({name: 'Big Lake', latitude: '31.1915437', longitude: '-101.4603945'}),
        knex('cities').insert({name: 'Big Spring', latitude: '32.2503979', longitude: '-101.4787355'}),
        knex('cities').insert({name: 'Boerne', latitude: '29.7946641', longitude: '-98.7319703'}),
        knex('cities').insert({name: 'Booker', latitude: '36.4533648', longitude: '-100.5373673'}),
        knex('cities').insert({name: 'Borger', latitude: '35.6678203', longitude: '-101.3973876'}),
        knex('cities').insert({name: 'Bowie', latitude: '33.5589953', longitude: '-97.8486457'}),
        knex('cities').insert({name: 'Bracketville', latitude: '29.3105125', longitude: '-100.4178563'}),
        knex('cities').insert({name: 'Brady', latitude: '31.1351682', longitude: '-99.3350552'}),
        knex('cities').insert({name: 'Breckenridge', latitude: '32.7556768', longitude: '-98.9022898'}),
        knex('cities').insert({name: 'Brenham', latitude: '30.1668828', longitude: '-96.3977442'}),
        knex('cities').insert({name: 'Brownfield', latitude: '33.1812035', longitude: '-102.2743489'}),
        knex('cities').insert({name: 'Brownsville', latitude: '25.9017472', longitude: '-97.4974838'}),
        knex('cities').insert({name: 'Brownwood', latitude: '31.7093197', longitude: '-98.9911611'}),
        knex('cities').insert({name: 'Burkburnett', latitude: '34.0978711', longitude: '-98.5706134'}),
        knex('cities').insert({name: 'Burnet', latitude: '30.7582376', longitude: '-98.2283585'}),
        knex('cities').insert({name: 'Cactus', latitude: '36.0522574', longitude: '-102.0023992'}),
        knex('cities').insert({name: 'Canadian', latitude: '35.91282', longitude: '-100.3820772'}),
        knex('cities').insert({name: 'Canton', latitude: '32.5565244', longitude: '-95.8632996'}),
        knex('cities').insert({name: 'Canyon', latitude: '34.9803342', longitude: '-101.9188024'}),
        knex('cities').insert({name: 'Carlsbad', latitude: '32.4206736', longitude: '-104.2288375'}),
        knex('cities').insert({name: 'Carrizo Springs', latitude: '28.5219292', longitude: '-99.8606107'}),
        knex('cities').insert({name: 'Carta Valley', latitude: '29.79001', longitude: '-100.671501'}),
        knex('cities').insert({name: 'Carthage', latitude: '32.1573841', longitude: '-94.3374199'}),
        knex('cities').insert({name: 'Catarina', latitude: '28.3455475', longitude: '-99.6133788'}),
        knex('cities').insert({name: 'Center', latitude: '31.7954512', longitude: '-94.1790862'}),
        knex('cities').insert({name: 'Childress', latitude: '34.4264529', longitude: '-100.2040019'}),
        knex('cities').insert({name: 'Chilicothe', latitude: '34.2564708', longitude: '-99.5167558'}),
        knex('cities').insert({name: 'Cisco', latitude: '32.3881861', longitude: '-98.9792336'}),
        knex('cities').insert({name: 'Clarendon', latitude: '34.9378289', longitude: '-100.8881993'}),
        knex('cities').insert({name: 'Clarksville', latitude: '33.6106648', longitude: '-95.052722'}),
        knex('cities').insert({name: 'Claude', latitude: '35.1117176', longitude: '-101.3632223'}),
        knex('cities').insert({name: 'Coleman', latitude: '31.8273679', longitude: '-99.4264532'}),
        knex('cities').insert({name: 'College Station', latitude: '30.627977', longitude: '-96.3344068'}),
        knex('cities').insert({name: 'Colorado City', latitude: '32.3881745', longitude: '-100.8645576'}),
        knex('cities').insert({name: 'Columbus', latitude: '29.7066232', longitude: '-96.5396933'}),
        knex('cities').insert({name: 'Comanche', latitude: '31.8973693', longitude: '-98.6036581'}),
        knex('cities').insert({name: 'Comfort', latitude: '29.967715', longitude: '-98.9050337'}),
        knex('cities').insert({name: 'Commerce', latitude: '33.2470567', longitude: '-95.8999656'}),
        knex('cities').insert({name: 'Concan', latitude: '29.5014937', longitude: '-99.7214883'}),
        knex('cities').insert({name: 'Conroe', latitude: '30.3118769', longitude: '-95.4560512'}),
        knex('cities').insert({name: 'Copperas Cove', latitude: '31.124062', longitude: '-97.9030785'}),
        knex('cities').insert({name: 'Cornudas', latitude: '31.77944', longitude: '-105.465103'}),
        knex('cities').insert({name: 'Corpus Christi', latitude: '27.8005828', longitude: '-97.396381'}),
        knex('cities').insert({name: 'Corsicana', latitude: '32.0954304', longitude: '-96.4688727'}),
        knex('cities').insert({name: 'Cotulla', latitude: '28.436934', longitude: '-99.2350322'}),
        knex('cities').insert({name: 'Crane', latitude: '31.3973624', longitude: '-102.3501419'}),
        knex('cities').insert({name: 'Crockett', latitude: '31.3182359', longitude: '-95.4566136'}),
        knex('cities').insert({name: 'Crosbyton', latitude: '33.6600847', longitude: '-101.2379276'}),
        knex('cities').insert({name: 'Crowell', latitude: '33.983973', longitude: '-99.7248158'}),
        knex('cities').insert({name: 'Crystal City', latitude: '28.6774795', longitude: '-99.8281104'}),
        knex('cities').insert({name: 'Cuero', latitude: '29.0938652', longitude: '-97.2891568'}),
        knex('cities').insert({name: 'Dalhart', latitude: '36.0594772', longitude: '-102.5132497'}),
        knex('cities').insert({name: 'Dallas', latitude: '32.7766642', longitude: '-96.7969879'}),
        knex('cities').insert({name: 'Decatur', latitude: '33.2342834', longitude: '-97.5861393'}),
        knex('cities').insert({name: 'Del Rio', latitude: '29.3708857', longitude: '-100.8958674'}),
        knex('cities').insert({name: 'Denison', latitude: '33.7556593', longitude: '-96.536658'}),
        knex('cities').insert({name: 'Denver City', latitude: '32.9645475', longitude: '-102.8290963'}),
        knex('cities').insert({name: 'Diboll', latitude: '31.1871319', longitude: '-94.7810412'}),
        knex('cities').insert({name: 'Dilley', latitude: '28.6674802', longitude: '-99.1705887'}),
        knex('cities').insert({name: 'Dimmitt', latitude: '34.5509028', longitude: '-102.3118607'}),
        knex('cities').insert({name: 'Dryden', latitude: '30.0446889', longitude: '-102.1143845'}),
        knex('cities').insert({name: 'Dumas', latitude: '35.8653789', longitude: '-101.9732236'}),
        knex('cities').insert({name: 'Eastland', latitude: '32.4015198', longitude: '-98.8175623'}),
        knex('cities').insert({name: 'Edinburg', latitude: '26.3017374', longitude: '-98.1633432'}),
        knex('cities').insert({name: 'Eden', latitude: '31.216276', longitude: '-99.8456277'}),
        knex('cities').insert({name: 'Edna', latitude: '28.9785947', longitude: '-96.6460877'}),
        knex('cities').insert({name: 'El Campo', latitude: '29.1966405', longitude: '-96.2696867'}),
        knex('cities').insert({name: 'El Paso', latitude: '31.7618778', longitude: '-106.4850217'}),
        knex('cities').insert({name: 'Eldorado', latitude: '30.8601745', longitude: '-100.6009299'}),
        knex('cities').insert({name: 'Enical', latitude: '28.041117', longitude: '-99.3544787'}),
        knex('cities').insert({name: 'Fairfield', latitude: '31.7246128', longitude: '-96.1652481'}),
        knex('cities').insert({name: 'Falfurrias', latitude: '27.2269872', longitude: '-98.1441714'}),
        knex('cities').insert({name: 'Floresville', latitude: '29.1335781', longitude: '-98.1561192'}),
        knex('cities').insert({name: 'Floydada', latitude: '33.9845232', longitude: '-101.3376574'}),
        knex('cities').insert({name: 'Fort Davis', latitude: '30.5882111', longitude: '-103.8946253'}),
        knex('cities').insert({name: 'Fort Hancock', latitude: '31.2914585', longitude: '-105.860307'}),
        knex('cities').insert({name: 'Fort Stockton', latitude: '30.8940431', longitude: '-102.8793222'}),
        knex('cities').insert({name: 'Fort Worth', latitude: '32.7554883', longitude: '-97.3307658'}),
        knex('cities').insert({name: 'Fredricksburg', latitude: '30.2752011', longitude: '-98.8719843'}),
        knex('cities').insert({name: 'Freer', latitude: '27.8827965', longitude: '-98.6177929'}),
        knex('cities').insert({name: 'Friona', latitude: '34.641734', longitude: '-102.7241047'}),
        knex('cities').insert({name: 'Fritch', latitude: '35.6397655', longitude: '-101.603228'}),
        knex('cities').insert({name: 'Gail', latitude: '32.7703457', longitude: '-101.445743'}),
        knex('cities').insert({name: 'Gainesville', latitude: '33.6259414', longitude: '-97.1333453'}),
        knex('cities').insert({name: 'Gatesville', latitude: '31.4351645', longitude: '-97.743911'}),
        knex('cities').insert({name: 'Galveston', latitude: '29.3013479', longitude: '-94.7976958'}),
        knex('cities').insert({name: 'Garden City', latitude: '31.8639016', longitude: '-101.4811969'}),
        knex('cities').insert({name: 'George West', latitude: '28.3325002', longitude: '-98.1175054'}),
        knex('cities').insert({name: 'Georgetown', latitude: '30.6332618', longitude: '-97.6779842'}),
        knex('cities').insert({name: 'Giddings', latitude: '30.1827159', longitude: '-96.936371'}),
        knex('cities').insert({name: 'Gilmer', latitude: '32.7287472', longitude: '-94.9424379'}),
        knex('cities').insert({name: 'Goliad', latitude: '28.6683252', longitude: '-97.3883265'}),
        knex('cities').insert({name: 'Gonzales', latitude: '29.5016257', longitude: '-97.4524926'}),
        knex('cities').insert({name: 'Goodnight', latitude: '35.042488', longitude: '-101.192001'}),
        knex('cities').insert({name: 'Graham', latitude: '33.1070597', longitude: '-98.589502'}),
        knex('cities').insert({name: 'Granbury', latitude: '32.4420826', longitude: '-97.7941967'}),
        knex('cities').insert({name: 'Grandfalls', latitude: '31.3393072', longitude: '-102.8518202'}),
        knex('cities').insert({name: 'Grape Creek', latitude: '31.5898783', longitude: '-100.5431534'}),
        knex('cities').insert({name: 'Groom', latitude: '35.2036602', longitude: '-101.1068215'}),
        knex('cities').insert({name: 'Guthrie', latitude: '33.6206613', longitude: '-100.3228034'}),
        knex('cities').insert({name: 'Harker Heights', latitude: '31.0835102', longitude: '-97.6597376'}),
        knex('cities').insert({name: 'Harlingen', latitude: '26.1906306', longitude: '-97.6961026'}),
        knex('cities').insert({name: 'Haskell', latitude: '33.1576031', longitude: '-99.7337014'}),
        knex('cities').insert({name: 'Hearne', latitude: '30.8785238', longitude: '-96.5930258'}),
        knex('cities').insert({name: 'Hebbronville', latitude: '27.3067057', longitude: '-98.6783516'}),
        knex('cities').insert({name: 'Henderson', latitude: '32.1532156', longitude: '-94.7993802'}),
        knex('cities').insert({name: 'Hereford', latitude: '34.8150622', longitude: '-102.3977036'}),
        knex('cities').insert({name: 'Hermleigh', latitude: '32.6351114', longitude: '-100.7592804'}),
        knex('cities').insert({name: 'Hilsboro', latitude: '32.0109886', longitude: '-97.1300061'}),
        knex('cities').insert({name: 'Hobbes', latitude: '32.7026116', longitude: '-103.1360403'}),
        knex('cities').insert({name: 'Houston', latitude: '29.7604267', longitude: '-95.3698028'}),
        knex('cities').insert({name: 'Huntsville', latitude: '30.7235263', longitude: '-95.5507771'}),
        knex('cities').insert({name: 'Iowa Park', latitude: '33.9514847', longitude: '-98.6686709'}),
        knex('cities').insert({name: 'Iraan', latitude: '30.9140478', longitude: '-101.8979061'}),
        knex('cities').insert({name: 'Jacksonville', latitude: '31.963778', longitude: '-95.2705042'}),
        knex('cities').insert({name: 'Jasper', latitude: '30.9201995', longitude: '-93.9965759'}),
        knex('cities').insert({name: 'Jefferson', latitude: '32.7573626', longitude: '-94.3451926'}),
        knex('cities').insert({name: 'Junction', latitude: '30.4893555', longitude: '-99.7720109'}),
        knex('cities').insert({name: 'Juno', latitude: '30.148689', longitude: '-101.116997'}),
        knex('cities').insert({name: 'Kames City', latitude: '28.8849772', longitude: '-97.9008355'}),
        knex('cities').insert({name: 'Katy', latitude: '29.7857853', longitude: '-95.8243956'}),
        knex('cities').insert({name: 'Kenedy', latitude: '28.8191468', longitude: '-97.8486123'}),
        knex('cities').insert({name: 'Kermit', latitude: '31.8576265', longitude: '-103.0926652'}),
        knex('cities').insert({name: 'Kerrville', latitude: '30.0474332', longitude: '-99.1403189'}),
        knex('cities').insert({name: 'Kilgore', latitude: '32.3862619', longitude: '-94.8757709'}),
        knex('cities').insert({name: 'Killeen', latitude: '31.1171194', longitude: '-97.7277959'}),
        knex('cities').insert({name: 'Kingsville', latitude: '27.5158689', longitude: '-97.856109'}),
        knex('cities').insert({name: 'Knox City', latitude: '33.4181509', longitude: '-99.8189804'}),
        knex('cities').insert({name: 'La Grange', latitude: '29.9055033', longitude: '-96.876647'}),
        knex('cities').insert({name: 'Lake Jackson', latitude: '29.0338575', longitude: '-95.4343859'}),
        knex('cities').insert({name: 'Lakeview', latitude: '31.6293316', longitude: '-97.1027792'}),
        knex('cities').insert({name: 'Lamesa', latitude: '32.7376001', longitude: '-101.950992'}),
        knex('cities').insert({name: 'Lampasas', latitude: '31.063784', longitude: '-98.1816957'}),
        knex('cities').insert({name: 'Langtry', latitude: '29.8085582', longitude: '-101.5596817'}),
        knex('cities').insert({name: 'Laredo', latitude: '27.5305671', longitude: '-99.4803241'}),
        knex('cities').insert({name: 'Laughlin AFB', latitude: '29.3565576', longitude: '-100.7830826'}),
        knex('cities').insert({name: 'Leakey', latitude: '29.7288351', longitude: '-99.761448'}),
        knex('cities').insert({name: 'Levelland', latitude: '33.5873164', longitude: '-102.37796'}),
        knex('cities').insert({name: 'Lindale', latitude: '32.5156971', longitude: '-95.4093998'}),
        knex('cities').insert({name: 'Littlefield', latitude: '33.9173148', longitude: '-102.3249022'}),
        knex('cities').insert({name: 'Livingston', latitude: '30.711029', longitude: '-94.9329898'}),
        knex('cities').insert({name: 'Llano', latitude: '30.7593452', longitude: '-98.6750379'}),
        knex('cities').insert({name: 'Longview', latitude: '32.5007037', longitude: '-94.7404891'}),
        knex('cities').insert({name: 'Loving', latitude: '32.2862317', longitude: '-104.095773'}),
        knex('cities').insert({name: 'Lubbock', latitude: '33.5778631', longitude: '-101.8551665'}),
        knex('cities').insert({name: 'Lufkin', latitude: '31.3382406', longitude: '-94.729097'}),
        knex('cities').insert({name: 'Madisonville', latitude: '30.9499111', longitude: '-95.9116188'}),
        knex('cities').insert({name: 'Marathon', latitude: '30.2051688', longitude: '-103.2446205'}),
        knex('cities').insert({name: 'Marble Falls', latitude: '30.5782446', longitude: '-98.2728003'}),
        knex('cities').insert({name: 'Marfa', latitude: '30.3094622', longitude: '-104.020623'}),
        knex('cities').insert({name: 'Marshall', latitude: '32.5448714', longitude: '-94.3674184'}),
        knex('cities').insert({name: 'Mason', latitude: '30.7487884', longitude: '-99.230611'}),
        knex('cities').insert({name: 'Matador', latitude: '34.0120211', longitude: '-100.8220785'}),
        knex('cities').insert({name: 'Mathis', latitude: '28.0944558', longitude: '-97.8280543'}),
        knex('cities').insert({name: 'McAllen', latitude: '26.2034071', longitude: '-98.2300124'}),
        knex('cities').insert({name: 'McCarney', latitude: '31.1322516', longitude: '-102.2222058'}),
        knex('cities').insert({name: 'McLean', latitude: '35.2325495', longitude: '-100.5998558'}),
        knex('cities').insert({name: 'Melvin', latitude: '31.1951678', longitude: '-99.5797854'}),
        knex('cities').insert({name: 'Memphis', latitude: '34.7247758', longitude: '-100.5340144'}),
        knex('cities').insert({name: 'Menard', latitude: '30.9176736', longitude: '-99.7864587'}),
        knex('cities').insert({name: 'Mentone', latitude: '31.7051291', longitude: '-103.5993477'}),
        knex('cities').insert({name: 'Mertzon', latitude: '31.2618316', longitude: '-100.8173263'}),
        knex('cities').insert({name: 'Midland', latitude: '31.9973456', longitude: '-102.0779146'}),
        knex('cities').insert({name: 'Mineola', latitude: '32.6631884', longitude: '-95.4882896'}),
        knex('cities').insert({name: 'Monahans', latitude: '31.5942991', longitude: '-102.8926536'}),
        knex('cities').insert({name: 'Morton', latitude: '33.7250974', longitude: '-102.7593763'}),
        knex('cities').insert({name: 'Mt Pleasant', latitude: '33.1567863', longitude: '-94.968269'}),
        knex('cities').insert({name: 'Mt Vernon', latitude: '33.1887271', longitude: '-95.2213321'}),
        knex('cities').insert({name: 'Muleshoe', latitude: '34.2264676', longitude: '-102.7238263'}),
        knex('cities').insert({name: 'Munday', latitude: '33.4492628', longitude: '-99.6228637'}),
        knex('cities').insert({name: 'Nacogdoches', latitude: '31.6035129', longitude: '-94.6554874'}),
        knex('cities').insert({name: 'Navasota', latitude: '30.3879845', longitude: '-96.0877349'}),
        knex('cities').insert({name: 'Nederland', latitude: '29.9743803', longitude: '-93.9923965'}),
        knex('cities').insert({name: 'New Boston', latitude: '33.4598415', longitude: '-94.4154787'}),
        knex('cities').insert({name: 'New Braunfels', latitude: '29.7030024', longitude: '-98.1244531'}),
        knex('cities').insert({name: 'Odessa', latitude: '31.8456816', longitude: '-102.3676431'}),
        knex('cities').insert({name: 'Orange', latitude: '30.0929879', longitude: '-93.7365549'}),
        knex('cities').insert({name: 'Orla', latitude: '31.8234585', longitude: '-103.9089837'}),
        knex('cities').insert({name: 'Ozona', latitude: '30.7022249', longitude: '-101.2013819'}),
        knex('cities').insert({name: 'Paducah', latitude: '34.0123005', longitude: '-100.3020588'}),
        knex('cities').insert({name: 'Palestine', latitude: '31.7621153', longitude: '-95.6307891'}),
        knex('cities').insert({name: 'Pampa', latitude: '35.5361559', longitude: '-100.9598709'}),
        knex('cities').insert({name: 'Pandale', latitude: '30.18067', longitude: '-101.5492019'}),
        knex('cities').insert({name: 'Panhandle', latitude: '35.3456038', longitude: '-101.3804447'}),
        knex('cities').insert({name: 'Paris', latitude: '33.6609389', longitude: '-95.555513'}),
        knex('cities').insert({name: 'Pasadena', latitude: '29.6910625', longitude: '-95.2091006'}),
        knex('cities').insert({name: 'Pearland', latitude: '29.5635666', longitude: '-95.2860474'}),
        knex('cities').insert({name: 'Pearsall', latitude: '28.8921939', longitude: '-99.095033'}),
        knex('cities').insert({name: 'Pecos', latitude: '31.4229124', longitude: '-103.4932293'}),
        knex('cities').insert({name: 'Perico', latitude: '36.270031', longitude: '-102.867104'}),
        knex('cities').insert({name: 'Perryton', latitude: '36.4000313', longitude: '-100.8026505'}),
        knex('cities').insert({name: 'Pflugerville', latitude: '30.4393696', longitude: '-97.6200043'}),
        knex('cities').insert({name: 'Pine Springs', latitude: '31.89378', longitude: '-104.797997'}),
        knex('cities').insert({name: 'Pittsburg', latitude: '32.9954021', longitude: '-94.9657688'}),
        knex('cities').insert({name: 'Plains', latitude: '33.1887135', longitude: '-102.8279888'}),
        knex('cities').insert({name: 'Plainview', latitude: '34.1847936', longitude: '-101.7068417'}),
        knex('cities').insert({name: 'Plano', latitude: '33.0198431', longitude: '-96.6988856'}),
        knex('cities').insert({name: 'Pleasanton', latitude: '28.967194', longitude: '-98.4786269'}),
        knex('cities').insert({name: 'Port Aransas', latitude: '27.8339158', longitude: '-97.0610994'}),
        knex('cities').insert({name: 'Port Arthur', latitude: '29.8849504', longitude: '-93.939947'}),
        knex('cities').insert({name: 'Port Lavaca', latitude: '28.6149968', longitude: '-96.6260892'}),
        knex('cities').insert({name: 'Port O\'Connor', latitude: '28.4475898', longitude: '-96.4053596'}),
        knex('cities').insert({name: 'Portland', latitude: '27.8772463', longitude: '-97.3238805'}),
        knex('cities').insert({name: 'Post', latitude: '33.1909283', longitude: '-101.3781941'}),
        knex('cities').insert({name: 'Quanah', latitude: '34.297855', longitude: '-99.7403718'}),
        knex('cities').insert({name: 'Quebec', latitude: '30.5107032', longitude: '-104.399643'}),
        knex('cities').insert({name: 'Ranger', latitude: '32.4698522', longitude: '-98.6789477'}),
        knex('cities').insert({name: 'Rankin', latitude: '31.2226477', longitude: '-101.9379085'}),
        knex('cities').insert({name: 'Rio Bravo', latitude: '27.3641887', longitude: '-99.4800415'}),
        knex('cities').insert({name: 'Riviera', latitude: '27.2986493', longitude: '-97.8148885'}),
        knex('cities').insert({name: 'Rockport', latitude: '28.0205733', longitude: '-97.0544341'}),
        knex('cities').insert({name: 'RockSprings', latitude: '30.0157647', longitude: '-100.2053582'}),
        knex('cities').insert({name: 'Rosenburg', latitude: '29.5571825', longitude: '-95.8085623'}),
        knex('cities').insert({name: 'Rosenfeld', latitude: '30.103333', longitude: '-102.751667'}),
        knex('cities').insert({name: 'Round Rock', latitude: '30.5082551', longitude: '-97.678896'}),
        knex('cities').insert({name: 'Rusk', latitude: '31.7960064', longitude: '-95.1502214'}),
        knex('cities').insert({name: 'Ryan', latitude: '30.43', longitude: '-104.298333'}),
        knex('cities').insert({name: 'San Angelo', latitude: '31.4637723', longitude: '-100.4370375'}),
        knex('cities').insert({name: 'San Antonio', latitude: '29.4241219', longitude: '-98.4936282'}),
        knex('cities').insert({name: 'San Augustine', latitude: '31.5299029', longitude: '-94.1060282'}),
        knex('cities').insert({name: 'San Diego', latitude: '27.7639145', longitude: '-98.2388953'}),
        knex('cities').insert({name: 'San Marcos', latitude: '29.8832749', longitude: '-97.9413941'}),
        knex('cities').insert({name: 'San Saba', latitude: '31.1957234', longitude: '-98.718098'}),
        knex('cities').insert({name: 'Sanderson', latitude: '30.1424083', longitude: '-102.3940324'}),
        knex('cities').insert({name: 'Santa Anna', latitude: '31.7420932', longitude: '-99.3217254'}),
        knex('cities').insert({name: 'Saragosa', latitude: '31.0245647', longitude: '-103.6556709'}),
        knex('cities').insert({name: 'Seadrift', latitude: '28.4152807', longitude: '-96.7135933'}),
        knex('cities').insert({name: 'Seagraves', latitude: '32.9442651', longitude: '-102.564915'}),
        knex('cities').insert({name: 'Seguin', latitude: '29.5688411', longitude: '-97.9647269'}),
        knex('cities').insert({name: 'Seminole', latitude: '32.7189926', longitude: '-102.6449101'}),
        knex('cities').insert({name: 'Seymour', latitude: '33.5942608', longitude: '-99.2603531'}),
        knex('cities').insert({name: 'Shafter', latitude: '29.8201733', longitude: '-104.3032532'}),
        knex('cities').insert({name: 'Shamrock', latitude: '35.2142167', longitude: '-100.2490075'}),
        knex('cities').insert({name: 'Sheffield', latitude: '30.6904452', longitude: '-101.8226258'}),
        knex('cities').insert({name: 'Sherman', latitude: '33.6356618', longitude: '-96.6088805'}),
        knex('cities').insert({name: 'Sierra Blanca', latitude: '31.1745732', longitude: '-105.3571764'}),
        knex('cities').insert({name: 'Silverton', latitude: '34.4742306', longitude: '-101.3046051'}),
        knex('cities').insert({name: 'Slaton', latitude: '33.4373113', longitude: '-101.6434915'}),
        knex('cities').insert({name: 'Snyder', latitude: '32.7178862', longitude: '-100.9176184'}),
        knex('cities').insert({name: 'Socorro', latitude: '31.654557', longitude: '-106.3033145'}),
        knex('cities').insert({name: 'Sonora', latitude: '30.5668484', longitude: '-100.6434273'}),
        knex('cities').insert({name: 'Spearman', latitude: '36.1983665', longitude: '-101.1923795'}),
        knex('cities').insert({name: 'Spring', latitude: '30.0799405', longitude: '-95.4171601'}),
        knex('cities').insert({name: 'Spur', latitude: '33.4764767', longitude: '-100.8556857'}),
        knex('cities').insert({name: 'Stamford', latitude: '32.9453874', longitude: '-99.8028709'}),
        knex('cities').insert({name: 'Stanton', latitude: '32.1292891', longitude: '-101.7884642'}),
        knex('cities').insert({name: 'Stephenville', latitude: '32.2206958', longitude: '-98.2022633'}),
        knex('cities').insert({name: 'Sterling City', latitude: '31.8362502', longitude: '-100.9848324'}),
        knex('cities').insert({name: 'Stratford', latitude: '36.3361402', longitude: '-102.0721191'}),
        knex('cities').insert({name: 'Sudan', latitude: '34.0678644', longitude: '-102.5243624'}),
        knex('cities').insert({name: 'Sugar Land', latitude: '29.6196787', longitude: '-95.6349463'}),
        knex('cities').insert({name: 'Sulphur Springs', latitude: '33.1384479', longitude: '-95.6010668'}),
        knex('cities').insert({name: 'Sunray', latitude: '36.0167027', longitude: '-101.824616'}),
        knex('cities').insert({name: 'Sweetwater', latitude: '32.4709519', longitude: '-100.4059384'}),
        knex('cities').insert({name: 'Temple', latitude: '31.0982344', longitude: '-97.342782'}),
        knex('cities').insert({name: 'Texarkana', latitude: '33.425125', longitude: '-94.0476882'}),
        knex('cities').insert({name: 'Texline', latitude: '36.3778066', longitude: '-103.0240968'}),
        knex('cities').insert({name: 'Texon', latitude: '31.224874', longitude: '-101.6895665'}),
        knex('cities').insert({name: 'The Woodlands', latitude: '30.1658207', longitude: '-95.4612625'}),
        knex('cities').insert({name: 'Three Rivers', latitude: '28.4602717', longitude: '-98.1825071'}),
        knex('cities').insert({name: 'Tulia', latitude: '34.5358942', longitude: '-101.7585159'}),
        knex('cities').insert({name: 'Turkey', latitude: '34.3925639', longitude: '-100.8976408'}),
        knex('cities').insert({name: 'Tyler', latitude: '32.3512601', longitude: '-95.3010624'}),
        knex('cities').insert({name: 'Uvalde', latitude: '29.2096836', longitude: '-99.7861679'}),
        knex('cities').insert({name: 'Valentine', latitude: '30.5873662', longitude: '-104.4965912'}),
        knex('cities').insert({name: 'Van Horn', latitude: '31.0398558', longitude: '-104.8307698'}),
        knex('cities').insert({name: 'Vega', latitude: '35.2428319', longitude: '-102.4282607'}),
        knex('cities').insert({name: 'Vernon', latitude: '34.1545306', longitude: '-99.2650804'}),
        knex('cities').insert({name: 'Victoria', latitude: '28.8052674', longitude: '-97.0035982'}),
        knex('cities').insert({name: 'Wall', latitude: '31.3740447', longitude: '-100.3075293'}),
        knex('cities').insert({name: 'Waco', latitude: '31.549333', longitude: '-97.1466695'}),
        knex('cities').insert({name: 'Waka', latitude: '36.2815527', longitude: '-101.0482521'}),
        knex('cities').insert({name: 'Wellington', latitude: '34.856166', longitude: '-100.2137263'}),
        knex('cities').insert({name: 'Wheeler', latitude: '35.4453257', longitude: '-100.2709552'}),
        knex('cities').insert({name: 'Whites City', latitude: '32.1756724', longitude: '-104.3766136'}),
        knex('cities').insert({name: 'Wichita Falls', latitude: '33.9137085', longitude: '-98.4933873'}),
        knex('cities').insert({name: 'Wickett', latitude: '31.5701328', longitude: '-103.0009898'}),
        knex('cities').insert({name: 'Wink', latitude: '31.7512396', longitude: '-103.1598876'}),
        knex('cities').insert({name: 'Winters', latitude: '31.9565343', longitude: '-99.962313'}),
        knex('cities').insert({name: 'Woodville', latitude: '30.7752011', longitude: '-94.4154758'}),
        knex('cities').insert({name: 'Woodway', latitude: '31.5059998', longitude: '-97.2050055'}),
        knex('cities').insert({name: 'Zapata', latitude: '26.9072605', longitude: '-99.2714255'}),
      ]);
    })
    .then(function() {
      return Promise.all([
